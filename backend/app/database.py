"""JSON file-based database layer for AgriData Platform."""
import json
import os
import threading
import uuid
...
class JSONDatabase:
    """Thread-safe JSON file storage with full CRUD operations."""

    def __init__(self, data_dir: Optional[str] = None):
        self.data_dir = Path(data_dir or settings.get_data_dir())
    ...
    def _save_data(self, table: str, data: List[Dict]) -> None:
        file_path = self.data_dir / f"{table}.json"
        with open(file_path, "w") as f:
